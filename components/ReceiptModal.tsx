    ...
    <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-[1100] p-4 sm:p-6 backdrop-blur-xl overflow-y-auto">
      <div className="bg-white rounded-[3rem] w-full max-w-xl overflow-hidden flex flex-col shadow-2xl relative max-h-[95vh]">
        ...
        <div className="flex-1 overflow-y-auto p-6 bg-gray-100 flex flex-col items-center">
          <div id="receipt-content" className="bg-white w-full max-w-[420px] p-8 shadow-2xl border-t-[12px] border-black font-mono text-black flex flex-col print:shadow-none print:border-none print:m-0 print:w-full print:max-w-none">
             ...
             <div className="mb-6 border-b-2 border-dashed border-black pb-4">
                {transaction.items.map((item, idx) => (
                   <div key={idx} className="flex justify-between items-start mb-3 font-black text-lg leading-tight">
                      ...
                      <div className="whitespace-nowrap">{currencySymbol}{(item.price * item.quantity).toFixed(2)}</div>
                   </div>
                ))}
             </div>
             ...
             {/* Footer */}
             <div className="mt-8 text-center font-black uppercase text-lg border-t-2 border-black pt-6">
