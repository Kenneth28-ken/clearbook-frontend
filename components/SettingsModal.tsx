...
const SettingsModal: React.FC<SettingsModalProps> = ({ 
  ...
  const handleExportBackup = () => {
    ...
    const safeString = safeJsonStringify(backupData);
             ...
             <div className="grid grid-cols-2 gap-3">
                ...
                {isMaster && onOpenMasterDashboard && (
                  <button 
                    ...
                    className="col-span-2 py-4 bg-amber-500 text-amber-950 rounded-2xl text-xs font-black uppercase tracking-widest hover:bg-amber-400 transition-all active:scale-95 flex items-center justify-center gap-3 shadow-lg shadow-amber-500/20 mt-2"
                  >
